...
export default function Home(){
 ...
 function setType(id:number,type:ElementType){updateBlocks(scene.blocks!.map(b=>b.id===id?{...b,type,text:["scene","character","transition","shot"].includes(type)?b.text.toUpperCase():b.text}:b));focusBlock(id)}
