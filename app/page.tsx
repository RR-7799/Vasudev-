...
export default function Home(){
 const[project,setProject]=useState<Project>(starter),[active,setActive]=useState(1),[saved,setSaved]=useState(true),[focused,setFocused]=useState<number|null>(1),[recent,setRecent]=useState<string[]>([]);\n const fileInput=useRef<HTMLInputElement|null>(null);
 ...
 function newProject(){const title="Untitled Film";setProject({...starter,title,scenes:starter.scenes.map(s=>({...s,blocks:s.blocks?.map(b=>({...b}))}))});setActive(1);setSaved(false);remember(title)}
